...
const TOOL_NAVIGATION_PROMPT = `Ты — resolver следующего инструмента для Telegram-ассистента.
...
- ориентируйся не только на совпадение слов, но и на смысл запроса
