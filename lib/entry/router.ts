...
- если данных мало, выбирай ask_question и исходи из одного лучшего следующего вопроса
...
Смысл action:
- capability: пользователь хочет понять, что умеет бот
...
- ask_question: один ответ пользователя заметно уменьшит неопределённость
