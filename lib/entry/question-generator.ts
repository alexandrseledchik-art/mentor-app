...
- если цель звучит как "продать бизнес", "выйти из операционки", "навести порядок", "подготовиться к росту", ищи вопрос про главный стоп-фактор, а не про саму цель
- лучший вопрос обычно должен помогать отличить одну рабочую гипотезу от другой, а не просто просить ещё текста
